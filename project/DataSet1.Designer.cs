...
SELECT userid, fname, lname, age, phone, gender, department, photo, Position, salary FROM emptab WHERE (userid = @userid)";
        ...
        public virtual int Fill(DataSet1.emptabDataTable dataTable) {
        ...
        public virtual DataSet1.emptabDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1.emptabDataTable dataTable = new DataSet1.emptabDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.emptabDataTable dataTable) {
